<head>
    ...
    <link
        href="{{
            asset('assets/plugins/perfect-scrollbar/css/perfect-scrollbar.css')
        }}"
        rel="stylesheet"
    />
    <link
    ...
    <link
        href="{{
            asset('assets/plugins/datatable/css/dataTables.bootstrap5.min.css')
        }}"
        rel="stylesheet"
    />
    <!-- loader-->
    ...
    <link
        href="{{ asset('assets/css/bootstrap-extended.css') }}"
        rel="stylesheet"
    />
    <link
    ...
    <link
        rel="stylesheet"
        href="https://developercodez.com/developerCorner/parsley/parsley.css"
    />
