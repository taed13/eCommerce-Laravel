          ...
          <table class="table align-middle mb-0">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <img
                    src="{{asset('assets/images/products/01.png')}}"
                    class="product-img-2"
                    alt="product img" />
                </td>
                <td>#9405822</td>
              ...
              <tr>
                ...
                <td>
                  <img
                    src="{{asset('assets/images/products/02.png')}}"
                    class="product-img-2"
                    alt="product img" />
                </td>
                <td>#8304620</td>
              ...
              <tr>
                ...
                <td>
                  <img
                    src="{{asset('assets/images/products/03.png')}}"
                    class="product-img-2"
                    alt="product img" />
                </td>
                <td>#4736890</td>
              ...
              <tr>
                ...
                <td>
                  <img
                    src="{{asset('assets/images/products/04.png')}}"
                    class="product-img-2"
                    alt="product img" />
                </td>
                <td>#8543765</td>
              ...
              <tr>
                ...
                <td>
                  <img
                    src="{{asset('assets/images/products/06.png')}}"
                    class="product-img-2"
                    alt="product img" />
                </td>
                <td>#9629240</td>
              ...
              <tr>
                ...
                <td>
                  <img
                    src="{{asset('assets/images/products/05.png')}}"
                    class="product-img-2"
                    alt="product img" />
                </td>
                <td>#8506790</td>
