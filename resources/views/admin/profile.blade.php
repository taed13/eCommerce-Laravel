              ...
              <div class="card-body">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <a href="{{Auth::User()->twitter_link}}" class="text-secondary" style="text-decoration: underline;">{{Auth::User()->twitter_link}}</a>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <a href="{{Auth::User()->insta_link}}" class="text-secondary" style="text-decoration: underline;">{{Auth::User()->insta_link}}</a>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <a href="{{Auth::User()->fb_link}}" class="text-secondary" style="text-decoration: underline;">{{Auth::User()->fb_link}}</a>
                  </li>
                </ul>
              </div>
            </div>
