...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="col pb-2 text-end">
            <button type="button" onclick="saveData('0', '', '')" class="btn btn-outline-primary px-5 radius-30" data-bs-toggle="modal" data-bs-target="#exampleModal" id="addBrand">Add New</button>
        </div>
        <div class="card">
            <div class="card-body">
                    ...
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" onclick="saveData('{{$list->id}}', '{{$list->text}}', '{{$list->image}}')" class="btn btn-outline-primary px-4 radius-30" data-bs-toggle="modal" data-bs-target="#exampleModal" id="updateBrand">
                                        Edit
                                    </button>
                                    <button type="button" class="btn btn-outline-danger px-4 radius-30" onclick="deleteData('{{$list->id}}', 'brands')">
                                        Delete
                                    </button>
                                </td>
                            </tr>
                ...
                <div class="modal-body">
                    <div class="border p-4 rounded">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-info">Brand Info</h5>
                        </div>
                        <hr />
                        <div class="row mb-3">
...
<script>
    ...
    // set  exampleModalLabel to Add Brand or update Brand
